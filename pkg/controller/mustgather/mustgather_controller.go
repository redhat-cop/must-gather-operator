...
var log = logf.Log.WithName("controller_mustgather")
...
func newReconciler(mgr manager.Manager) reconcile.Reconciler {
	return &ReconcileMustGather{client: mgr.GetClient(), scheme: mgr.GetScheme()}
}

// add adds a new Controller to mgr with r as the reconcile.Reconciler
func add(mgr manager.Manager, r reconcile.Reconciler) error {
	// Create a new controller
	c, err := controller.New("mustgather-controller", mgr, controller.Options{Reconciler: r})
	if err != nil {
		return err
	}

	// Watch for changes to primary resource MustGather
	err = c.Watch(&source.Kind{Type: &redhatcopv1alpha1.MustGather{}}, &handler.EnqueueRequestForObject{})
	if err != nil {
		return err
	}
...
func newPodForCR(cr *redhatcopv1alpha1.MustGather) *corev1.Pod {
